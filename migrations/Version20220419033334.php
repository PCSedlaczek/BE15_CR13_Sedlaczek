 ...
 */
final class Version20220419033334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD organizer_id INT DEFAULT NULL, DROP organizer');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD organizer VARCHAR(255) DEFAULT NULL, DROP organizer_id');
    }
}
